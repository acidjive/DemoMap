package com.example.a16022578.demomap;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //gets the reference to the Google Map object.
        // The object will only be ready when it is fully loaded.
        // The time this object needs depends on the Internet connection,
        // thus it’s tracked separately
        mapFragment.getMapAsync(new OnMapReadyCallback(){
            ...
            public void onMapReady(GoogleMap googleMap) {
                ...
                //Demo Map app to ZOOM to Causeway Point, Woodlands
